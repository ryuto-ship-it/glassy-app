// Placeholder $CHARM token allocation. These figures are illustrative only —
...
export const TOKENOMICS_ALLOCATION: TokenomicsSlice[] = [
  { key: 'community', label: '커뮤니티 · 리워드', value: 30, color: '#4FB6E8' },
  ...
  { key: 'liquidity', label: '유동성 · 락업', value: 10, color: '#1B5FA8' },
